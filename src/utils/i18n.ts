...
export const translations = {
  en: {
    ...
    "today.hot": "Today's Hot",
    "baidu.hot": "Baidu Trends",
    "refresh.hint": "Click to refresh",
    "search.placeholder": "Search...",
    "search.not_found": "No results found. Please submit an issue on Github.",
    "loading": "Loading...",
  },
  zh: {
    // Menu items
    ...
    "search.not_found": "没有找到，可以前往 Github 提 issue",
    "loading": "加载中...",
  },
} as const
...
export const englishSources = [
  ...
  // Ars Technica - English tech news
  "arstechnica",
]
